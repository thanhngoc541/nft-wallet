...
export class Floorplan extends EventDispatcher {
    ...
    loadFloorplan(floorplan) {
        ...
        let currentUnit = Configuration.getValue(configDimUnit, 1);
        if (floorplan.units) {
        ...
        /** Create:
         * Tạo corner
         * Định nghĩa chiều cao của các corner ?
         * */
        ...
        floorplan.walls.forEach((wall) => {
            ...
            if (Version.isVersionHigherThan(floorplan.version, '0.0.2a')) {
                ...
                console.log("wall type ", newWall.wallType)
            }
        });
        ...
        /** Create:
         * Tạo background cho 2D
         * Giới hạn phần biên giớ vẽ floorplan
         * */
        ...
        console.log('rooms 1, ', this.getRooms())
        this.update();
        console.log('rooms 2, ', this.getRooms())
    ...
    loadLockedFloorplan(floorplan) {
        ...
        let currentUnit = Configuration.getValue(configDimUnit, 2);
        if (floorplan.units) {
            switch (floorplan.units) {
                case dimInch:
                    Configuration.setValue(configDimUnit, dimInch);
        ...
        for (let id in floorplan.corners) {
            ...
            let corner = new Corner(this, Dimensioning.cmFromMeasureRaw(cornerData.x), Dimensioning.cmFromMeasureRaw(cornerData.y), undefined);
