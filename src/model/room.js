...
import {defaultFloorTexture, TEXTURE_DEFAULT_REPEAT, WallTypes} from '../core/constants.js';
...
export class Room extends EventDispatcher {
    ...
    generateRoofPlane() {
        ...
        if (!this.roofPlane) {
            ...
            this.roofPlane.geometry = geometry; //this.roofPlane.geometry.fromGeometry(geometry);
        }
    ...
    generateFloorPlane() {
        ...
        if (!this.floorPlane) {
            ...
            this.floorPlane.geometry = geometry; //this.floorPlane.geometry.fromGeometry(geometry);
        }
